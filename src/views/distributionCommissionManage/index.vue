    ...
    <div class='container'>
        ...
        <div class="center">
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="commissionCnyAmount.decimalTwoString" width="150px" label="佣金发放总金额" align="center" />
                <el-table-column prop="rewardAmount2.decimalTwoString" width="150px" label="直推" align="center" />
                <el-table-column prop="rewardAmount3.decimalTwoString" width="150px" label="会员管理" align="center" />
                <el-table-column prop="rewardAmount4.decimalTwoString" width="150px" label="运营商" align="center" />
                <el-table-column prop="rewardAmount6.decimalTwoString" width="150px" label="基地" align="center" />
                <el-table-column prop="payTime" width="180px" label="创建时间" align="center" />
                <!-- <el-table-column prop="goodsNum" label="关联商品数量" align="center" />
                <el-table-column prop="settlementCycle" label="结算周期" align="center">
                    <template #default="scope">
                        <div class="notEffective" v-if="scope.row.settlementCycle ==0">
                            周
                        </div>
                        <div class="takeEffects" v-if="scope.row.settlementCycle ==1">
                            月
                        </div>
                    </template>
                    </el-table-column>
...
<script>
import { searchCommissionList } from '@/api/autarkyManage/distributionCommissionManage'
...
export default {
    ...
    methods: {
        ...
        searchTableList() {
            ...
            searchCommissionList(data).then(res => {
                console.log(res)
                if (res.success) {
