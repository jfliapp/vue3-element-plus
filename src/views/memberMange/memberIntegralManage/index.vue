    ...
    <div class='container'>
        ...
        <div class="center">
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="tpPoints.decimalFourString" label="TP积分" align="center" />
                <el-table-column prop="agentPoints.decimalFourString" label="合作商积分" align="center" />
                <el-table-column prop="proPoints.decimalFourString" label="PRO积分" align="center" />
...
<script>
import { getUserPointList } from '@/api/member'
...
export default {
    ...
    methods: {
        ...
        searchTableList() {
            ...
            getUserPointList(data).then(res => {
                console.log(res)
                if (res.success) {
