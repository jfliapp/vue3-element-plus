      ...
      <ElRow :gutter="20">
        <ElCol :span="8">
          <div style="background: var(--detail-user-bg)">
            <OwnDivider title="基本信息" :show-action="true" @action="basicAction" />
            <Form
              :is-custom="false"
        ...
        <ElCol :span="8">
          <ElRow>
            <ElCol>
              <div style="background: var(--detail-user-bg)">
                <OwnDivider title="状态设置" :show-action="true" @action="statusAction" />
                <Form
                  :is-custom="false"
                  label-position="right"
                  hide-required-asterisk
          ...
          <ElRow>
            <ElCol>
              <div style="background: var(--detail-user-bg)">
                <OwnDivider title="权限设置" :show-action="true" @action="authAction" />
                <Form
                  :is-custom="false"
                  label-position="right"
                  hide-required-asterisk
        ...
        <ElCol :span="8">
          <ElRow>
            <ElCol>
              <div style="background: var(--detail-user-bg)">
                <OwnDivider title="密码设置" :show-action="true" @action="pswAction" />
                <Form
                  :is-custom="false"
                  label-position="right"
                  hide-required-asterisk
